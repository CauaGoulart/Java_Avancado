...
public class UserResourceTest {
	...
	public void testGetUsersByName() {
	    ResponseEntity<List<UserDTO>> responseEntity = rest.exchange("/user/name/Usuario teste 1", HttpMethod.GET, null, new ParameterizedTypeReference<List<UserDTO>>() {});
	    assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
	...
	public void testGetAllUsers() {
	    ResponseEntity<List<UserDTO>> responseEntity = rest.exchange("/user", HttpMethod.GET, null, new ParameterizedTypeReference<List<UserDTO>>() {});
	    assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
	    List<UserDTO> userList = responseEntity.getBody();
	    assertNotNull(userList);
