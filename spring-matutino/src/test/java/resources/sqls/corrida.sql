...
insert into corrida(id_corrida,data_corrida,pista_id_pista,campeonato_id_campeonato) values(1,2005,1,1);
insert into corrida(id_corrida,data_corrida,pista_id_pista,campeonato_id_campeonato) values(2,2010,2,2);
